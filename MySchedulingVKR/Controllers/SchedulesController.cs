...
namespace MySchedulingVKR.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public SchedulesController(DbSchedulingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dbSchedulingContext = _context.Schedules.Include(s => s.Lesson);
        ...
        public async Task<IActionResult> Create([Bind("LessonId")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LessonId")] Schedule schedule)
        {
            if (id != schedule.LessonId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ScheduleExists(schedule.LessonId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Schedules.Any(e => e.LessonId == id);
        }
    }
}
